...
exports.default = {
    ...
    vuex: {
        getters: {
            ...
            token: _getters.getToken,
            authenticated: _getters.getAuthenticated
        },
    ...
    events: {
        ...
        clearUserDetails: function clearUserDetails() {
            ...
            if (this.$route.auth) this.$router.go('/prihlasit');
        }
    }
};
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7648081a", module.exports)
  } else {
    hotAPI.update("_v-7648081a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./vuex/actions":23,"./vuex/getters":24,"./vuex/store.js":25,"vue":6,"vue-hot-reload-api":2}],10:[function(require,module,exports){
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-79695b80", module.exports)
  } else {
    hotAPI.update("_v-79695b80", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\t<input type=\"text\" class=\"form-control\" initial=\"off\" id=\"email\" v-validate:email=\"{ \n                  required: { rule: true, message: 'Email je povinný !!' },\n                  email   : { rule: true, message: 'Nezadali ste email v správnom tvare !!'}\n\n                }\">\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3ab2dad7", module.exports)
  } else {
    hotAPI.update("_v-3ab2dad7", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":6,"vue-hot-reload-api":2}],12:[function(require,module,exports){
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\t<nav class=\"navbar navbar-default\">\n  <div class=\"container\">\n    <!-- Brand and toggle get grouped for better mobile display -->\n    <div class=\"navbar-header\">\n      <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#bs-example-navbar-collapse-1\" aria-expanded=\"false\">\n        <span class=\"sr-only\">Toggle navigation</span>\n        <span class=\"icon-bar\"></span>\n        <span class=\"icon-bar\"></span>\n        <span class=\"icon-bar\"></span>\n      </button>\n      <a class=\"navbar-brand\" v-link=\"{ path: '/prihlasit'}\">Registrácia a authentifikácia</a>\n    </div>\n\n    <!-- Collect the nav links, forms, and other content for toggling -->\n    <div class=\"collapse navbar-collapse\" id=\"bs-example-navbar-collapse-1\">\n      <ul class=\"nav navbar-nav\">\n<!--         <li  class=\"active\"><a  v-link=\"{ path: '/spomienky-na-zosnulych' }\">DOMOV</a></li>\n -->        <li v-if=\"!$root.authenticated\"><a v-link=\"{ path: '/prihlasit'}\">PRIHLÁSIŤ SA</a></li>\n      </ul>\n      <ul class=\"nav navbar-nav navbar-right\">\n          <li v-if=\"$root.authenticated\"><a v-link=\"{ path: '/odhlasit-sa'}\">ODHLÁSIŤ SA</a></li>\n      </ul>\n    </div><!-- /.navbar-collapse -->\n  </div><!-- /.container-fluid -->\n</nav>\n \n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-15ffdd21", module.exports)
  } else {
    hotAPI.update("_v-15ffdd21", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
},{"./general/error-message.vue":10,"./general/input-email.vue":11,"./general/nav.vue":12,"vue":6}],14:[function(require,module,exports){
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2b075c14", module.exports)
  } else {
    hotAPI.update("_v-2b075c14", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
    ...
    validators: {
        confirm: function confirm(val, target) {
            return val === target;
        },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-521a90d6", module.exports)
  } else {
    hotAPI.update("_v-521a90d6", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
"use strict";
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\t<navigation></navigation>\n\t <div class=\"container\">\n\t\t <!--<h2>Vitajte {{$root.user.username}}</h2>-->\n\t </div>\n    <router-view></router-view>\n\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-20e69b6d", module.exports)
  } else {
    hotAPI.update("_v-20e69b6d", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":6,"vue-hot-reload-api":2,"vueify/lib/insert-css":7}],18:[function(require,module,exports){
'use strict';
    ...
    Vue.http.interceptors.push({
        ...
        response: function response(_response) {
            ...
            if (_response.data && _response.data.token && _response.data.token.length > 10) {
                localStorage.setItem('jwt-token', 'Bearer ' + _response.data.token);
            }
            return _response;
        }
...
},{"./app.vue":9,"./components/register":13,"./interceptors":18,"./routes":20,"./validator/register":22,"vue":6,"vue-resource":3,"vue-router":4,"vue-validator":5}],20:[function(require,module,exports){
'use strict';
...
},{"./components/views/auth.vue":14,"./components/views/auth/login.vue":15,"./components/views/auth/logout.vue":16,"./components/views/domov.vue":17}],21:[function(require,module,exports){
"use strict";
...
module.exports = {
	...
	registerAllValidationRules: function registerAllValidationRules() {}

};

},{"./email":21,"vue":6}],23:[function(require,module,exports){
'use strict';
...
function saveUser(_ref, user) {
    var dispatch = _ref.dispatch;

    dispatch('LOGIN', user);
}

function clearUser(_ref2) {
...
function getAuthenticated(state) {
...
var mutations = {
    LOGIN: function LOGIN(state, user) {
        state.user.data = user, state.user.token = localStorage.getItem('jwt-token'), state.user.authenticated = true;
    },
    LOGOUT: function LOGOUT(state) {
        state.user.data = null, state.user.token = null, state.user.authenticated = false;
    }
};
